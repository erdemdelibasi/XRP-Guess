...
ETH_SYMBOL = "ETHUSDT"
INTERVAL = "15m"
BACKTEST_CANDLES = 8000  # ~83 days of 15-min candles
TRAIN_FRACTION = 0.7
...
def run_backtest() -> None:
    ...
    for i in range(test_start, n - 1):
        ...
        decision = trading.compute_rebalance(cash, xrp, price, final["direction"], final["confidence"], peak_value)
        ...
        resolved_count += 1
        if actual_direction == final["direction"]:
            correct_count += 1
